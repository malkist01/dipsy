...
# ==== NOTIF START ====
sendTG "🚀 *Kernel Build Started!*%0ADevice: *Ginkgo*%0AKernel: *Neophyte Solstice*A10%0ABuild Zip: *$ZIPNAME*"
...
sendTG "✅ *Build Success!*%0AZip: *$ZIPNAME*%0AUploading file..."
...
sendTG "🎉 *Done!*%0ACompleted in *$DURATION*"

echo -e "Completed in $DURATION"
echo "Zip: $ZIPNAME"
